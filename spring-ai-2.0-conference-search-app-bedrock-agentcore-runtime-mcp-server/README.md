...
A Spring AI 2.0 application that exposes conference search capabilities through Model Context Protocol (MCP) tools. This application enables natural language interactions with conference data via MCP clients like Amazon Q Developer or MCP Inspector.
