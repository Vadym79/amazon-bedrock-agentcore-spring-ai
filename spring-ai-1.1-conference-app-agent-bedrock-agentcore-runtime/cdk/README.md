...
AWS CDK for Java infrastructure for Conference Search And Application Agent implemented with Spring AI deployed on Amazon Bedrock Agentcore MCP servers based on AgentCore Runtime
