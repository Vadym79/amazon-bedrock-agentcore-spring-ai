# Spring AI 2.0 Conference App Agent — Amazon Bedrock AgentCore Runtime
...
```
target/spring-ai-2.0-conference-app-agent-bedrock-agentcore-runtime-0.0.1-SNAPSHOT.jar
```
...
```bash
java -jar target/spring-ai-2.0-conference-app-agent-bedrock-agentcore-runtime-0.0.1-SNAPSHOT.jar
```
