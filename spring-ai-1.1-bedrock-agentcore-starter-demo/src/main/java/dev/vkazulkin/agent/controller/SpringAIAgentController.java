...
public class SpringAIAgentController   {
	...
	/**
	 * post endpoint to receive agent requests and respond synchronously
	 * @param promptRequest - prompt request
	 * @return synchronous agent response
	 */
	@AgentCoreInvocation
	...
	/**
	 * post endpoint to receive agent requests and respond asynchronously
	 * @param promptRequest - prompt request
	 * @return asynchronous agent response
	 */
	//@AgentCoreInvocation
